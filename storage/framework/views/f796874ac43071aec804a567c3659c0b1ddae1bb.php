                        ...
                        <tr>
                            <td>
                                <a data-enterprise="<?php echo e($obj->fantasia); ?>"
                                   data-url="<?php echo e(route("api.demonstrative.register", [
                            ...
                            <td><?php echo e($obj->user->name); ?></td>
                            <td><?php echo e($obj->cnpj); ?></td>
                            <td><?php echo e($obj->fantasia); ?></td>
                            <td><?php echo e($obj->razao_social); ?></td>
                            <td><?php echo e($obj->email); ?></td>
                            <td><a class="btn btn-sm btn-block btn-success" href="<?php echo e(route('adm_view_enterprise', ['id' => $obj->id])); ?>"><i class="fa fa-money"></i>&nbsp; Demonstrativo</a></td>
                            <td><a class="btn btn-sm btn-block btn-warning" href="<?php echo e(route('empresas.edit',['id' => $obj->id])); ?>"><i class="fa fa-pencil"></i>&nbsp; Editar</a></td>
                        </tr>
