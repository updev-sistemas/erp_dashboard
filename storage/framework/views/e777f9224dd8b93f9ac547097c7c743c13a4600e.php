...
<?php $__env->startSection('pageTitle'); ?>
    Contas a Pagar de <?php echo e($enterprise->fantasia); ?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <div>
                                    <figure class="avatar">
                                        <img src="<?php echo e(url('assets/media/image/user/contaReceber.png')); ?>">
                                    </figure>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <div>
                                    <figure class="avatar">
                                        <img src="<?php echo e(url('assets/media/image/user/contaPendente.png')); ?>">
                                    </figure>
                                </div>
                            </div>
                            <div class="d-inline-flex align-items-center">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-3">
                                ...
                                <div>
                                    <figure class="avatar">
                                        <img src="<?php echo e(url('assets/media/image/user/contaVencida.png')); ?>">
                                    </figure>
                                </div>
                            </div>
                            <div class="d-inline-flex align-items-center">
